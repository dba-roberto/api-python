...
from schemas.usuario_schema import UsuarioSchemaArtigos, UsuarioSchemaCreate, UsuarioSchemaBase, UsuarioSchemaUp
...
async def login(form_data: OAuth2PasswordRequestForm = Depends(), db: AsyncSession = Depends(get_session)):
    ...
    return JSONResponse(content={"acces_token": criar_token_acesso(sub=usuario.id), "token_type": "bearer"}, status_code=status.HTTP_200_OK)
